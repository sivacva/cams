        ...
        <div class="col-12">
            <div class="card" style="border-color: #7198b9">
                <div class="card-body">
                    ...
                    <div class="wizard">
                        <!-- Step Navigation -->
                        <ul class="nav nav-pills nav-justified p-3 rounded" style="font-size: 14px;">
                            <li class="nav-item active" mb-3> <a class="nav-link  position-relative rounded-3 active"
                                    href="#step1" data-bs-toggle="tab"> <span class="step-circle">1</span> Entry Meeting
                                </a> </li>
                            <li class="nav-item"> <a class="nav-link  position-relative rounded-3" href="#step2"
                                    data-bs-toggle="tab"> <span class="step-circle">2</span> Work Allocation </a> </li>
                            <li class="nav-item"> <a class="nav-link position-relative rounded-3" href="#step3"
                                    data-bs-toggle="tab"> <span class="step-circle"><?php echo $auditslip; ?></span> Audit Slip
                                </a> </li>
                            <li class="nav-item"> <a class="nav-link position-relative rounded-3" href="#step4"
                                    data-bs-toggle="tab"> <span class="step-circle"><?php echo $view_auditslip; ?></span>Audit
                                    Slip Reply</a> </li>
                            <li class="nav-item" <?php echo $show_tab; ?>> <a class="nav-link position-relative rounded-3"
                                    href="#step5" data-bs-toggle="tab"> <span class="step-circle">5</span> Exit Meeting
                                </a> </li>
                        </ul>
                        <div class="tab-content">
                            <!-- Step 1 -->
                            <div class="tab-pane fade  bg-white p-4 rounded active show" id="step1">
                                <form>
                                    <div class="row">
                                        <div class="col-md-4 mb-3"> <label class="form-label"
                                                for="validationDefault02">Entry Meet Date</label>
                                            <div class="input-group" onclick="datepicker('from_date','')"> <input
                                                    type="text" class="form-control datepicker" id="from_date"
                                                    name="from_date" placeholder="dd/mm/yyyy" value="<?php echo $fromdate; ?>"
                                                    disabled /> <span class="input-group-text"> <i
                                                        class="ti ti-calendar fs-5"></i> </span> </div>
                                        </div>
                                                ...
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="p-3 align-items-center ms-auto">
                                                        <h3 class="text-primary box mb-0"
                                                            onclick="downloadFile('Entrymeeting.pdf')"> <i
                                        ...
                                        <div class="col-md-4"> <label class="form-label" for="validationDefault02">Code
                                            ...
                                            <div class="card overflow-hidden">
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="p-3 align-items-center ms-auto">
                                                        <h3 class="text-primary box mb-0"
                                                            onclick="downloadFile('codeofethics.pdf')"> <i
                                                                class="ti ti-download"></i>
                                                        </h3>
                                                    </div>
                                                </div>
                            ...
                            <div class="tab-pane fade bg-white p-4 rounded" id="step2">
                                <div>
                                    <form <?php echo $show_workform; ?> id="work_allocation" name="work_allocation">
                                        <div class="alert alert-danger alert-dismissible fade show hide_this"
                                            role="alert" id="display_error">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label required" for="validationDefault01">Select Team
                                                    Member</label>
                                                <select class=" form-control custom-select" name="team_mem"
                                                    id="team_mem">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control datepicker" id="fromdate"
                                                        name="fromdate" placeholder="dd/mm/yyyy" disabled
                                                        value="<?php echo isset($inst_details->first()->fromdate) ? \Carbon\Carbon::parse($inst_details->first()->fromdate)->format('d/m/Y') : ''; ?>" />
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control datepicker" id="todate"
                                                        name="todate" placeholder="dd/mm/yyyy" disabled
                                                        value="<?php echo isset($inst_details->first()->todate) ? \Carbon\Carbon::parse($inst_details->first()->todate)->format('d/m/Y') : ''; ?>" />
                                                    <span class="input-group-text">
                                                        <i class="ti ti-calendar fs-5"></i>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select class="select2 form-control custom-select" multiple="multiple"
                                                    id="minorwa" name="minorwa[]" aria-placeholder="Select Member">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mx-auto">
                                                <input type="hidden" name="work_action" id="work_action"
                                                    value="insert" />
                                                <button class="btn button_save mt-3" type="submit" action="insert"
                                                    id="saveworkall" name="saveworkall">Save Draft </button>
                                                <button class="btn bg-success button_finalise mt-3" type="submit"
                                                    id="finaliseWork" action="finaliseWork">
                                                    Finalize
                                                </button>
                            ...
                            <!-- Step 3 -->
                            <div class="tab-pane fade bg-white rounded " id="step3">
                                <div class="row">
                                        ...
                                        <div class="card" style="border-color: #7198b9">
                                            ...
                                            <div class="card-body">
                                                <div id="auditslipcard">
                                                    <form id="auditslip" name="auditslip"> <input type="hidden"
                                                            name="autoslipnumber" id="autoslipnumber" value=34321>
                                                        <input type="hidden" name="currentslipnumber"
                                                            id="currentslipnumber" value=''> <input type="hidden"
                                                            name="deactive_fileid" id="deactive_fileid"> <input
                                                            type="hidden" name="active_fileid" id="active_fileid">
                                                        <input type="hidden" name="seriesno" id="seriesno"
                                                            value='1'> <input type="hidden" name="fileuploadstatus"
                                                            id="fileuploadstatus" value=''> <input type="hidden"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4"> <label class="form-label required lang"
                                                                    ...
                                                                    key="major_obj">Title/Heading</label> <select
                                                            ...
                                                            <div class="col-md-4 "> <label
                                                                ...
                                                                </label> <select class="select form-control custom-select"
                                                        ...
                                                        <div class="row mt-2">
                                                            ...
                                                            <div class="col-md-4 hide_this" id="liabilityname_div"> <label
                                                                    ...
                                                                    id="liabilityname" name="liabilityname"
                                                                    class="form-control"
                                                                    placeholder="Enter Liability name"> </div> --}}
                                                            <div class="col-md-4"> <label class="form-label required lang"
                                                                    for="validationDefaultUsername"
                                                                    key="slip_details">Slip
                                                                    Details</label>
                                                ...
                                                <div id="viewauditslipcard" class="hide_this">
                                                    <div class="row">
                                                        <div class="col-md-4"> <label class="form-label required lang"
                                                                ...
                                                                key="major_obj">Title/Heading</label> <select
                                                                class="select form-control custom-select"
                                                                id="view_majorobjectioncode"
                                                                name="view_majorobjectioncode"
                                                        ...
                                                        <div class="col-md-4"> <label class="form-label required lang"
                                                                ...
                                                                name="view_minorobjectioncode" class="form-control"
                                                                disabled> </div>
                                                        <div class="col-md-4 "> <label class="form-label"
                                                                for="validationDefaultUsername">Amount
                                                                Involved</label> <input type="text"
                                                                class="form-control" id="view_amount_involved"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="container col-md-3 my-1"
                                                            id="view_file-list-container">
                                                            <!-- File cards will be dynamically injected here -->
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <!-- Step 4 -->
                            <div class="tab-pane fade bg-white p-4 rounded" id="step4">
                                    ...
                                    <div class="col-md-2 d-none d-lg-block border-end user-chat-box">
                                        ...
                                        <div class=" pt-9 ">
                                            <div class="position-relative mb-4">
                                                <input type="text" class="form-control search-chat-view py-2 ps-5"
                                                    id="text-srh" placeholder="Search Slip" />
                                                <i
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 ">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="viewslip_amtinvolved" name="viewslip_amtinvolved"
                                                    ...
                                                    <div class="col-md-4 ">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="viewslip_form-check-input success"
                                                                type="radio" name="viewslip_liability" id="Ye"
                                                                value="Ye" disabled>
                                                            <label class="form-check-label" for="all">Yes</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="viewslip_form-check-input success"
                                                                type="radio" name="viewslip_liability" id="Noo"
                                                                value="Noo" checked disabled>
                                                            <label class="form-check-label" for="district">No</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-4 hide_this" id="viewslip_liabilitynamediv">
                                                        <label class="form-label required"
                                                            for="validationDefaultUsername">
                                                            Name</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label required"
                                                            ...
                                                            Attachment</label>
                                                        <div class="container my-1" id="viewslip_auditorcontainer">
                                                            <!-- File cards will be dynamically injected here -->
                                                        </div>
                                                    </div>
                                                    <hr class="mt-2">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            <label class="form-label required lang"
                                                                for="validationDefaultUsername" key="observation">Auditee
                                                                Remarks</label>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="form-label required"
                                                                ...
                                                                Attachment</label>
                                                            <div class="container my-1" id="viewslip_auditeecontainer">
                                                                <!-- File cards will be dynamically injected here -->
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="tab-pane fade  bg-white p-4 rounded <?php echo $show_tab; ?>" id="step5"
                                <?php echo $show_tab; ?>>
                                <form>
                                    <div class="row">
                                        <div class="col-md-4 mb-3"> <label class="form-label"
                                                for="validationDefault02">Exit Meet Date</label>
                                        ...
                                        <div class="col-md-4"> <label class="form-label" for="validationDefault02">Exit
                                            ...
                                            <div class="card overflow-hidden" style="border-color: #7198b9">
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="p-3 align-items-center ms-auto">
                                                        <h3 class="text-primary box mb-0"
                                                            onclick="downloadFile('Exitmeeting.pdf')"> <i
                                                                class="ti ti-download"></i>
                                                        </h3>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        $("#approvebtn").on("click", function() {
            ...
            if ($("#auditslip").valid()) {
                ...
                if (('<?php echo $teamhead; ?>' == 'Y')) alert_content = 'Are you sure to forward the slip details to the institution?';
                if (('<?php echo $teamhead; ?>' == 'N')) alert_content = 'Are you sure to forward the slip details to team head?';
                        ...
                        if (response.data && response.data.length > 0) {
                            ...
                            if (firstItem.encrypted_auditslipid) 
                            {
                                ...
                                if (firstItem.forwardedbyusername) {
                                    initiatedby = 'Initiated By ' + firstItem.forwardedbyusername + ' Forwarded on: ' + change_dateformat(firstItem.forwardedon);
                                } else {
